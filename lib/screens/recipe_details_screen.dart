...
import 'package:FoodRecipes/screens/profile_screen.dart';
                          ...
                          children: <Widget>[
                            Padding(
                                padding: const EdgeInsets.only(
                                    top: 20, left: 25, right: 5, bottom: 5),
                                child: Row(
                                    mainAxisAlignment:
                            ...
                            (widget.userId != userId) ? GestureDetector(
                            ...
                            MediaQuery.removePadding(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (ctx, index) =>
                                    commentListItem(context, comments, index),
      ...
      children: [
        ...
        Container(
          ...
          child: FlatButton(
            ...
            color: (_isFollowing == false) ? Colors.white : Colors.green,
