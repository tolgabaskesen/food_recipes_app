import 'package:FoodRecipes/constants.dart';
import 'package:FoodRecipes/models/recipe.dart';
import 'package:FoodRecipes/screens/recipe_details_screen.dart';
import 'package:FoodRecipes/screens/recipe_recent_list_screen.dart';
import 'package:FoodRecipes/services/http_service.dart';
import 'package:FoodRecipes/translation/app_localizations.dart';
import 'package:FoodRecipes/widgets/home_recipe_item.dart';
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          (widget.allRecipes != null) ? SearchWidget<Recipe>(
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: GoogleFonts.pacifico(color: Colors.black54, fontWeight: FontWeight.w100),
